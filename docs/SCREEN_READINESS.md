...
- Экранов проверено: **56**.
- Средняя архитектурная готовность: **83%**.
- Готово: **25**.
- Частично: **29**.
- Слабо описано: **2**.
...
| **Уведомления**<br><code>global.notifications</code> | <code>/notifications</code> | ✅ | ✅ | ◐ | ✅ | ◐ | ◐ | — | ◐ | ✅ | ✅ | **78% · частично** |
| **Главная**<br><code>home.main</code> | <code>/</code> | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | **100% · готово** |
| **События**<br><code>play.main</code> | <code>/play</code> | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | **100% · готово** |
| **Чаты**<br><code>chats.main</code> | <code>/chats</code> | ✅ | ✅ | ✅ | ✅ | ◐ | ○ | ✅ | ✅ | ◐ | ✅ | **80% · частично** |
| **Чат**<br><code>chat.details</code> | <code>/chats/:chatId</code> | ✅ | ✅ | ✅ | ◐ | ✅ | ✅ | ✅ | ◐ | ✅ | ✅ | **90% · готово** |
| **Клубы**<br><code>clubs.main</code> | <code>/clubs</code> | ✅ | ✅ | ◐ | ✅ | ◐ | ◐ | ✅ | ✅ | ◐ | ✅ | **80% · частично** |
...
| **Тренер**<br><code>trainer.public_profile</code> | <code>/trainers/:trainerId</code> | ✅ | ◐ | ◐ | ✅ | ◐ | ○ | ◐ | ◐ | ○ | ◐ | **50% · слабо** |
...
| № | Критерий | ✅ | ◐ | ○ | — |
|---:|---|---:|---:|---:|---:|
| 1 | ID и маршрут | 56 | 0 | 0 | 0 |
| 2 | Профили и права | 38 | 18 | 0 | 0 |
| 3 | Назначение и данные | 41 | 15 | 0 | 0 |
| 4 | Блоки | 35 | 21 | 0 | 0 |
| 5 | Действия | 34 | 21 | 1 | 0 |
| 6 | Состояния | 7 | 29 | 20 | 0 |
| 7 | Варианты ролей | 36 | 7 | 0 | 13 |
| 8 | Навигация | 38 | 18 | 0 | 0 |
| 9 | Интеграции | 45 | 6 | 1 | 4 |
| 10 | Спецификация | 51 | 5 | 0 | 0 |
...
- **Тренер** (`trainer.public_profile`, 50%): нет: Состояния, Интеграции; частично: Профили и права, Назначение и данные, Действия, Варианты ролей, Навигация, Спецификация.
...
- **Уведомления** (`global.notifications`, 78%): частично: Назначение и данные, Действия, Состояния, Навигация.
- **Чаты** (`chats.main`, 80%): нет: Состояния; частично: Действия, Интеграции.
