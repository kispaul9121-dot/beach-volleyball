...
| **Профиль**<br><code>home.main</code> | <code>/</code> | ✅ | ✅ | ✅ | ◐ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | **95% · готово** |
| **Игры**<br><code>play.main</code> | <code>/play</code> | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | **100% · готово** |
| **Чаты**<br><code>chats.main</code> | <code>/chats</code> | ✅ | ✅ | ✅ | ✅ | ✅ | ○ | ✅ | ✅ | ◐ | ✅ | **85% · частично** |
| **Чат**<br><code>chat.details</code> | <code>/chats/:chatId</code> | ✅ | ✅ | ✅ | ◐ | ✅ | ✅ | ✅ | ◐ | ✅ | ✅ | **90% · готово** |
| **Кэмпы**<br><code>camps.main</code> | <code>/camps</code> | ✅ | ✅ | ✅ | ✅ | ✅ | ◐ | ✅ | ✅ | ✅ | ✅ | **95% · готово** |
...
| **Мои турниры**<br><code>profile.competitions</code> | <code>/profile/competitions</code> | ✅ | ◐ | ✅ | ◐ | ◐ | ○ | ◐ | ◐ | ◐ | ◐ | **55% · слабо** |
...
| **Кэмп**<br><code>tour.details</code> | <code>/tours/:tourId</code> | ✅ | ✅ | ◐ | ✅ | ✅ | ○ | ✅ | ◐ | ✅ | ✅ | **80% · частично** |
...
| **Бронирование кэмпа**<br><code>tour.booking</code> | <code>/tours/:tourId/booking</code> | ✅ | ◐ | ◐ | ✅ | ◐ | ○ | ✅ | ◐ | ✅ | ✅ | **70% · частично** |
...
| 3 | Назначение и данные | 40 | 13 | 0 | 0 |
| 4 | Блоки | 31 | 22 | 0 | 0 |
| 5 | Действия | 35 | 17 | 1 | 0 |
| 6 | Состояния | 10 | 28 | 15 | 0 |
| 7 | Варианты ролей | 33 | 7 | 0 | 13 |
| 8 | Навигация | 39 | 14 | 0 | 0 |
| 9 | Интеграции | 45 | 4 | 0 | 4 |
| 10 | Спецификация | 46 | 7 | 0 | 0 |
...
- **Мои турниры** (`profile.competitions`, 55%): нет: Состояния; частично: Профили и права, Блоки, Действия, Варианты ролей, Навигация, Интеграции, Спецификация.
...
- **Мои кэмпы** (`profile.trips`, 70%): частично: Профили и права, Блоки, Действия, Состояния, Навигация, Спецификация.
- **Оплата** (`payment.checkout`, 70%): частично: Профили и права, Назначение и данные, Блоки, Действия, Состояния, Варианты ролей.
- **Бронирование кэмпа** (`tour.booking`, 70%): нет: Состояния; частично: Профили и права, Назначение и данные, Действия, Навигация.
- **Мои игры** (`profile.my_games`, 75%): частично: Профили и права, Блоки, Состояния, Варианты ролей, Спецификация.
- **Мои тренировки** (`profile.trainings`, 75%): нет: Состояния; частично: Профили и права, Навигация, Спецификация.
...
- **Создание игры** (`game.create`, 80%): нет: Состояния; частично: Профили и права, Действия.
