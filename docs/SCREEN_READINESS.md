...
| **Мои турниры**<br><code>profile.competitions</code> | <code>/profile/competitions</code> | ✅ | ◐ | ✅ | ✅ | ✅ | ○ | ✅ | ◐ | ✅ | ✅ | **80% · частично** |
...
| **Мои кэмпы**<br><code>profile.trips</code> | <code>/profile/trips</code> | ✅ | ◐ | ✅ | ✅ | ✅ | ◐ | ✅ | ✅ | ✅ | ✅ | **90% · готово** |
...
- **Мои турниры** (`profile.competitions`, 80%): нет: Состояния; частично: Профили и права, Навигация.
...
- **Детали платежа** (`payment.details`, 80%): частично: Назначение и данные, Блоки, Состояния, Варианты ролей.
- **Кэмп** (`tour.details`, 80%): нет: Состояния; частично: Назначение и данные, Навигация.
