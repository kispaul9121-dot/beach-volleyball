...
Первая вкладка является личной профильной страницей active actor. Она не содержит двухрежимного переключателя личной активности, кабинета управления, черновиков, заявок или операционных таблиц.
